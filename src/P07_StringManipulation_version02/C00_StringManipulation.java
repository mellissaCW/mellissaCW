package P07_StringManipulation_version02;
...
// codePointAt(): Belirtilen indisteki karakterin Unicode'unu verir. int döndürür.
        ...
        System.out.println("result 2 = "+(myStr.charAt(0)+0));
...
// concat(): Başka bir String'in sonuna bir karakter ekler. String döndürür.
        ...
        System.out.println(firstName+lastName); // usttekinin aynı
...
// isEmpty(): Bir dizenin boş olup olmadığını kontrol eder. boolean döndürür.
        ...
        String myStr16 = "";
        System.out.println(myStr15.isEmpty()); // false
        System.out.println(myStr16.isEmpty()); // true
        // lengt sıfır demektir, yani " ".isEmpty() false verir
...
// **toCharArray(): Bu iodize yeni bir karakter dizisine dönüştürür. char[] döndürür.
        ...
        for (char each : charArray) {
            System.out.println(each + " "); // M e r h a b a   d ü n y a !
        }

// *****valueOf(): Bir String nesnesinin ilkel değerini verir. String döndürür.
        String str22 = "22";
        int a=Integer.valueOf(str22) + 10;
        System.out.println("Integer valu of = " + a);
        str22 = String.valueOf(a)+10; // str22 = ""+a;
        System.out.println("String valu of = " + str22);
